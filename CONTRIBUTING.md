...
This repository packages SubImage products as Helm charts (currently one chart:
[`charts/subimage-outpost`](./charts/subimage-outpost)). There is no application code or package
manager here — the deliverable is the chart itself, developed with the Helm CLI.
